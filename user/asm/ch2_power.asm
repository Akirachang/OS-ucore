...
/home/akira/Desktop/compare/OS2/user/build/riscv64/ch2_power:     file format elf64-littleriscv
...
int main(void)
{
    ...
    100c:	6909                	lui	s2,0x2
    for (i = 1; i <= STEP; ++i)
    100e:	69e1                	lui	s3,0x18
{
    ...
    1016:	e456                	sd	s5,8(sp)
        pow[index] = (last * P) % MOD;
    1018:	71790a1b          	addiw	s4,s2,1815
{
    ...
    1020:	4489                	li	s1,2
        pow[index] = (last * P) % MOD;
    1022:	7109091b          	addiw	s2,s2,1808
        if ((i % 10000) == 0)
        {
            printf("%d^%d=%d\n", P, i, pow[index]);
    1026:	00001a97          	auipc	s5,0x1
    102a:	f72a8a93          	addi	s5,s5,-142 # 1f98 <unlink+0x18>
    for (i = 1; i <= STEP; ++i)
    102e:	6a198993          	addi	s3,s3,1697 # 186a1 <digits+0x166b9>
        if ((i % 10000) == 0)
    1032:	0324e7bb          	remw	a5,s1,s2
        pow[index] = (last * P) % MOD;
    1036:	0014169b          	slliw	a3,s0,0x1
    103a:	9c35                	addw	s0,s0,a3
    103c:	0344643b          	remw	s0,s0,s4
        if ((i % 10000) == 0)
    1040:	e799                	bnez	a5,104e <main+0x48>
            printf("%d^%d=%d\n", P, i, pow[index]);
    1042:	8626                	mv	a2,s1
    1044:	458d                	li	a1,3
    1046:	8556                	mv	a0,s5
    1048:	86a2                	mv	a3,s0
    104a:	0bc000ef          	jal	ra,1106 <printf>
    for (i = 1; i <= STEP; ++i)
    104e:	2485                	addiw	s1,s1,1
    1050:	ff3491e3          	bne	s1,s3,1032 <main+0x2c>
        }
    }
    puts("Test power OK!");
    1054:	00001517          	auipc	a0,0x1
    1058:	f5450513          	addi	a0,a0,-172 # 1fa8 <unlink+0x28>
    105c:	068000ef          	jal	ra,10c4 <puts>
    return 0;
}
    1060:	70e2                	ld	ra,56(sp)
    1062:	7442                	ld	s0,48(sp)
    1064:	74a2                	ld	s1,40(sp)
    1066:	7902                	ld	s2,32(sp)
    1068:	69e2                	ld	s3,24(sp)
    106a:	6a42                	ld	s4,16(sp)
    106c:	6aa2                	ld	s5,8(sp)
    106e:	4501                	li	a0,0
    ...
    111c:	00989b37          	lui	s6,0x989
{
    ...
    1138:	70f98993          	addi	s3,s3,1807 # 270f <digits+0x727>
    113c:	69fa8a93          	addi	s5,s5,1695 # 1869f <digits+0x166b7>
    1140:	23fa0a13          	addi	s4,s4,575 # f423f <digits+0xf2257>
    1144:	67fb0b13          	addi	s6,s6,1663 # 98967f <digits+0x987697>
    for (;;)
    {
        if (!*s)
    ...
    11a0:	e4c78793          	addi	a5,a5,-436 # 1fe8 <digits>
            printptr(va_arg(ap, uint64));
    ...
    133c:	cb078793          	addi	a5,a5,-848 # 1fe8 <digits>
    1340:	00f6f713          	andi	a4,a3,15
    1344:	973e                	add	a4,a4,a5
    1346:	00074703          	lbu	a4,0(a4) # ffffffffffff8000 <digits+0xffffffffffff6018>
    buf[16] = 0;
    ...
    145c:	b9078793          	addi	a5,a5,-1136 # 1fe8 <digits>
    buf[16] = 0;
    ...
    15a0:	a4c78793          	addi	a5,a5,-1460 # 1fe8 <digits>
    ...
    1602:	9ea78793          	addi	a5,a5,-1558 # 1fe8 <digits>
    buf[16] = 0;
    ...
    165e:	95e40413          	addi	s0,s0,-1698 # 1fb8 <unlink+0x38>
...
size_t strlen(const char *s)
{
    ...
    1a36:	59e5b583          	ld	a1,1438(a1) # 1fd0 <SIZE+0x4>
    1a3a:	00000617          	auipc	a2,0x0
    1a3e:	59e63603          	ld	a2,1438(a2) # 1fd8 <SIZE+0xc>
    ...
    1a6e:	00757713          	andi	a4,a0,7
{
    ...
    1a9e:	54653503          	ld	a0,1350(a0) # 1fe0 <SIZE+0x14>
    ...
    1ab0:	5248b883          	ld	a7,1316(a7) # 1fd0 <SIZE+0x4>
    1ab4:	00000817          	auipc	a6,0x0
    1ab8:	52483803          	ld	a6,1316(a6) # 1fd8 <SIZE+0xc>
    1abc:	431d                	li	t1,7
...
char *stpcpy(char *restrict d, const char *s)
{
    ...
    1b3e:	49663603          	ld	a2,1174(a2) # 1fd0 <SIZE+0x4>
    1b42:	00000817          	auipc	a6,0x0
    1b46:	49683803          	ld	a6,1174(a6) # 1fd8 <SIZE+0xc>
...
char *stpncpy(char *restrict d, const char *s, size_t n)
{
    ...
    1d20:	2b48b883          	ld	a7,692(a7) # 1fd0 <SIZE+0x4>
    1d24:	00000817          	auipc	a6,0x0
    1d28:	2b483803          	ld	a6,692(a6) # 1fd8 <SIZE+0xc>
    1d2c:	431d                	li	t1,7
