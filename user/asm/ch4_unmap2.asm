...
/home/akira/Desktop/compare/OS2/user/build/riscv64/ch4_unmap2:     file format elf64-littleriscv
    ...
    100c:	10000537          	lui	a0,0x10000
{
    ...
    assert(len == mmap((void *)start, len, prot));
    1012:	6cf000ef          	jal	ra,1ee0 <mmap>
    1016:	6785                	lui	a5,0x1
    1018:	00f50563          	beq	a0,a5,1022 <main+0x1c>
    101c:	557d                	li	a0,-1
    101e:	5df000ef          	jal	ra,1dfc <exit>
    assert(munmap((void *)start, len + 1) == -1);
    1022:	6585                	lui	a1,0x1
    1024:	0585                	addi	a1,a1,1
    1026:	10000537          	lui	a0,0x10000
    102a:	6c3000ef          	jal	ra,1eec <munmap>
    102e:	57fd                	li	a5,-1
    1030:	00f50563          	beq	a0,a5,103a <main+0x34>
    1034:	557d                	li	a0,-1
    1036:	5c7000ef          	jal	ra,1dfc <exit>
    assert(munmap((void *)(start + 1), len - 1) == -1);
    103a:	6585                	lui	a1,0x1
    103c:	10000537          	lui	a0,0x10000
    1040:	15fd                	addi	a1,a1,-1
    1042:	0505                	addi	a0,a0,1
    1044:	6a9000ef          	jal	ra,1eec <munmap>
    1048:	57fd                	li	a5,-1
    104a:	00f50563          	beq	a0,a5,1054 <main+0x4e>
    104e:	557d                	li	a0,-1
    1050:	5ad000ef          	jal	ra,1dfc <exit>
    puts("Test 04_6 ummap2 OK!");
    1054:	00001517          	auipc	a0,0x1
    1058:	f3450513          	addi	a0,a0,-204 # 1f88 <unlink+0x14>
    105c:	05c000ef          	jal	ra,10b8 <puts>
    return 0;
    ...
    1110:	00989b37          	lui	s6,0x989
{
    ...
    112c:	70f98993          	addi	s3,s3,1807 # 270f <digits+0x74f>
    1130:	69fa8a93          	addi	s5,s5,1695 # 1869f <digits+0x166df>
    1134:	23fa0a13          	addi	s4,s4,575 # f423f <digits+0xf227f>
    1138:	67fb0b13          	addi	s6,s6,1663 # 98967f <digits+0x9876bf>
    for (;;)
    {
        if (!*s)
    ...
    1194:	e3078793          	addi	a5,a5,-464 # 1fc0 <digits>
            printptr(va_arg(ap, uint64));
    ...
    1234:	0005c503          	lbu	a0,0(a1) # 1000 <_start>
    ...
    1330:	c9478793          	addi	a5,a5,-876 # 1fc0 <digits>
    1334:	00f6f713          	andi	a4,a3,15
    1338:	973e                	add	a4,a4,a5
    133a:	00074703          	lbu	a4,0(a4) # ffffffffffff8000 <digits+0xffffffffffff6040>
    buf[16] = 0;
    ...
    1450:	b7478793          	addi	a5,a5,-1164 # 1fc0 <digits>
    buf[16] = 0;
    ...
    1594:	a3078793          	addi	a5,a5,-1488 # 1fc0 <digits>
    ...
    15f6:	9ce78793          	addi	a5,a5,-1586 # 1fc0 <digits>
    buf[16] = 0;
    ...
    1652:	95240413          	addi	s0,s0,-1710 # 1fa0 <unlink+0x2c>
...
size_t strlen(const char *s)
{
    ...
    1a2a:	5825b583          	ld	a1,1410(a1) # 1fa8 <unlink+0x34>
    1a2e:	00000617          	auipc	a2,0x0
    1a32:	58263603          	ld	a2,1410(a2) # 1fb0 <unlink+0x3c>
    ...
    1a62:	00757713          	andi	a4,a0,7
{
    ...
    1a92:	52a53503          	ld	a0,1322(a0) # 1fb8 <unlink+0x44>
    ...
    1aa4:	5088b883          	ld	a7,1288(a7) # 1fa8 <unlink+0x34>
    1aa8:	00000817          	auipc	a6,0x0
    1aac:	50883803          	ld	a6,1288(a6) # 1fb0 <unlink+0x3c>
    1ab0:	431d                	li	t1,7
...
char *stpcpy(char *restrict d, const char *s)
{
    ...
    1b32:	47a63603          	ld	a2,1146(a2) # 1fa8 <unlink+0x34>
    1b36:	00000817          	auipc	a6,0x0
    1b3a:	47a83803          	ld	a6,1146(a6) # 1fb0 <unlink+0x3c>
...
char *stpncpy(char *restrict d, const char *s, size_t n)
{
    ...
    1d14:	2988b883          	ld	a7,664(a7) # 1fa8 <unlink+0x34>
    1d18:	00000817          	auipc	a6,0x0
    1d1c:	29883803          	ld	a6,664(a6) # 1fb0 <unlink+0x3c>
    1d20:	431d                	li	t1,7
