...
/home/akira/Desktop/compare/OS2/user/build/riscv64/ch5_usertest:     file format elf64-littleriscv
...
int main()
{
    ...
    1022:	0aaa8a93          	addi	s5,s5,170 # 20c8 <TESTS+0x78>
    ...
    114c:	00989b37          	lui	s6,0x989
{
    ...
    1168:	70f98993          	addi	s3,s3,1807 # 270f <digits+0x54f>
    116c:	69fa8a93          	addi	s5,s5,1695 # 1869f <digits+0x164df>
    1170:	23fa0a13          	addi	s4,s4,575 # f423f <digits+0xf207f>
    1174:	67fb0b13          	addi	s6,s6,1663 # 98967f <digits+0x9874bf>
    for (;;)
    {
        if (!*s)
    ...
    11d0:	ff478793          	addi	a5,a5,-12 # 21c0 <digits>
            printptr(va_arg(ap, uint64));
    ...
    136c:	e5878793          	addi	a5,a5,-424 # 21c0 <digits>
    1370:	00f6f713          	andi	a4,a3,15
    1374:	973e                	add	a4,a4,a5
    1376:	00074703          	lbu	a4,0(a4) # ffffffffffff8000 <digits+0xffffffffffff5e40>
    buf[16] = 0;
    ...
    148c:	d3878793          	addi	a5,a5,-712 # 21c0 <digits>
    buf[16] = 0;
    ...
    15d0:	bf478793          	addi	a5,a5,-1036 # 21c0 <digits>
    ...
    1632:	b9278793          	addi	a5,a5,-1134 # 21c0 <digits>
    buf[16] = 0;
