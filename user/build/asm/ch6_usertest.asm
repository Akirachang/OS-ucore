...
/home/akira/Desktop/compare/OS2/user/build/riscv64/ch6_usertest:     file format elf64-littleriscv
...
int main()
{
    ...
    1022:	0caa8a93          	addi	s5,s5,202 # 20e8 <TESTS+0x98>
    ...
    102a:	fa298993          	addi	s3,s3,-94 # 1fc8 <unlink+0x18>
        int pid = spawn(test);
        int xstate = 0;
    ...
    1032:	fb2a0a13          	addi	s4,s4,-78 # 1fe0 <unlink+0x30>
        char *test = TESTS[i];
    ...
    114c:	00989b37          	lui	s6,0x989
{
    ...
    1168:	70f98993          	addi	s3,s3,1807 # 270f <digits+0x4ef>
    116c:	69fa8a93          	addi	s5,s5,1695 # 1869f <digits+0x1647f>
    1170:	23fa0a13          	addi	s4,s4,575 # f423f <digits+0xf201f>
    1174:	67fb0b13          	addi	s6,s6,1663 # 98967f <digits+0x98745f>
    for (;;)
    {
        if (!*s)
    ...
    11d0:	05478793          	addi	a5,a5,84 # 2220 <digits>
            printptr(va_arg(ap, uint64));
    ...
    136c:	eb878793          	addi	a5,a5,-328 # 2220 <digits>
    1370:	00f6f713          	andi	a4,a3,15
    1374:	973e                	add	a4,a4,a5
    1376:	00074703          	lbu	a4,0(a4) # ffffffffffff8000 <digits+0xffffffffffff5de0>
    buf[16] = 0;
    ...
    148c:	d9878793          	addi	a5,a5,-616 # 2220 <digits>
    buf[16] = 0;
    ...
    15d0:	c5478793          	addi	a5,a5,-940 # 2220 <digits>
    ...
    1632:	bf278793          	addi	a5,a5,-1038 # 2220 <digits>
    buf[16] = 0;
