...
/home/akira/Desktop/compare/OS2/user/build/riscv64/ch5_spawn0:     file format elf64-littleriscv
...
int main()
{
    ...
    1010:	02800413          	li	s0,40
    for (int _ = 0; _ < MAX_CHILD; ++_)
    {
        int cpid = spawn("ch5_getpid\0");
    1014:	00001917          	auipc	s2,0x1
    1018:	ffc90913          	addi	s2,s2,-4 # 2010 <MAX_CHILD+0x20>
        assert(cpid >= 0); // "child pid invalid"
        printf("new child %d\n", cpid);
    101c:	00001497          	auipc	s1,0x1
    1020:	fac48493          	addi	s1,s1,-84 # 1fc8 <unlink+0x18>
        int cpid = spawn("ch5_getpid\0");
    1024:	854a                	mv	a0,s2
    1026:	71f000ef          	jal	ra,1f44 <spawn>
    102a:	85aa                	mv	a1,a0
        printf("new child %d\n", cpid);
    102c:	8526                	mv	a0,s1
        assert(cpid >= 0); // "child pid invalid"
    102e:	0605c063          	bltz	a1,108e <main+0x88>
    1032:	347d                	addiw	s0,s0,-1
        printf("new child %d\n", cpid);
    1034:	102000ef          	jal	ra,1136 <printf>
    for (int _ = 0; _ < MAX_CHILD; ++_)
    1038:	f475                	bnez	s0,1024 <main+0x1e>
    }
    int exit_code = 0;
    103a:	ce02                	sw	zero,28(sp)
    103c:	02800413          	li	s0,40
    for (int _ = 0; _ < MAX_CHILD; ++_)
    {
        assert(wait(&exit_code) > 0); // "wait stopped early"
    1040:	0868                	addi	a0,sp,28
    1042:	6f3000ef          	jal	ra,1f34 <wait>
    1046:	347d                	addiw	s0,s0,-1
    1048:	02a05f63          	blez	a0,1086 <main+0x80>
        assert(exit_code == 0);       // "error exit code"
    104c:	47f2                	lw	a5,28(sp)
    104e:	e79d                	bnez	a5,107c <main+0x76>
    for (int _ = 0; _ < MAX_CHILD; ++_)
    1050:	f865                	bnez	s0,1040 <main+0x3a>
    }
    assert(wait(&exit_code) < 0); // "wait got too many"
    1052:	0868                	addi	a0,sp,28
    1054:	6e1000ef          	jal	ra,1f34 <wait>
    1058:	00054563          	bltz	a0,1062 <main+0x5c>
    105c:	557d                	li	a0,-1
    105e:	5db000ef          	jal	ra,1e38 <exit>
    puts("Test spawn0 OK!");
    1062:	00001517          	auipc	a0,0x1
    1066:	f7650513          	addi	a0,a0,-138 # 1fd8 <unlink+0x28>
    106a:	08a000ef          	jal	ra,10f4 <puts>
    return 0;
    ...
    107a:	8082                	ret
        assert(exit_code == 0);       // "error exit code"
    107c:	557d                	li	a0,-1
    107e:	5bb000ef          	jal	ra,1e38 <exit>
    for (int _ = 0; _ < MAX_CHILD; ++_)
    1082:	fc5d                	bnez	s0,1040 <main+0x3a>
    1084:	b7f9                	j	1052 <main+0x4c>
        assert(wait(&exit_code) > 0); // "wait stopped early"
    1086:	557d                	li	a0,-1
    1088:	5b1000ef          	jal	ra,1e38 <exit>
    108c:	b7c1                	j	104c <main+0x46>
        assert(cpid >= 0); // "child pid invalid"
    108e:	557d                	li	a0,-1
    1090:	e42e                	sd	a1,8(sp)
    1092:	5a7000ef          	jal	ra,1e38 <exit>
        printf("new child %d\n", cpid);
    1096:	65a2                	ld	a1,8(sp)
    1098:	347d                	addiw	s0,s0,-1
    109a:	8526                	mv	a0,s1
    109c:	09a000ef          	jal	ra,1136 <printf>
    for (int _ = 0; _ < MAX_CHILD; ++_)
    10a0:	f051                	bnez	s0,1024 <main+0x1e>
    10a2:	bf61                	j	103a <main+0x34>
    ...
    114c:	00989b37          	lui	s6,0x989
{
    ...
    1168:	70f98993          	addi	s3,s3,1807 # 270f <digits+0x6ef>
    116c:	69fa8a93          	addi	s5,s5,1695 # 1869f <digits+0x1667f>
    1170:	23fa0a13          	addi	s4,s4,575 # f423f <digits+0xf221f>
    1174:	67fb0b13          	addi	s6,s6,1663 # 98967f <digits+0x98765f>
    for (;;)
    {
        if (!*s)
    ...
    11d0:	e5478793          	addi	a5,a5,-428 # 2020 <digits>
            printptr(va_arg(ap, uint64));
    ...
    136c:	cb878793          	addi	a5,a5,-840 # 2020 <digits>
    1370:	00f6f713          	andi	a4,a3,15
    1374:	973e                	add	a4,a4,a5
    1376:	00074703          	lbu	a4,0(a4) # ffffffffffff8000 <digits+0xffffffffffff5fe0>
    buf[16] = 0;
    ...
    148c:	b9878793          	addi	a5,a5,-1128 # 2020 <digits>
    buf[16] = 0;
    ...
    15d0:	a5478793          	addi	a5,a5,-1452 # 2020 <digits>
    ...
    1632:	9f278793          	addi	a5,a5,-1550 # 2020 <digits>
    buf[16] = 0;
    ...
    168e:	95e40413          	addi	s0,s0,-1698 # 1fe8 <unlink+0x38>
...
size_t strlen(const char *s)
{
    ...
    1a66:	5965b583          	ld	a1,1430(a1) # 1ff8 <MAX_CHILD+0x8>
    1a6a:	00000617          	auipc	a2,0x0
    1a6e:	59663603          	ld	a2,1430(a2) # 2000 <MAX_CHILD+0x10>
    ...
    1a9e:	00757713          	andi	a4,a0,7
{
    ...
    1ace:	53e53503          	ld	a0,1342(a0) # 2008 <MAX_CHILD+0x18>
    ...
    1ae0:	51c8b883          	ld	a7,1308(a7) # 1ff8 <MAX_CHILD+0x8>
    1ae4:	00000817          	auipc	a6,0x0
    1ae8:	51c83803          	ld	a6,1308(a6) # 2000 <MAX_CHILD+0x10>
    1aec:	431d                	li	t1,7
...
char *stpcpy(char *restrict d, const char *s)
{
    ...
    1b6e:	48e63603          	ld	a2,1166(a2) # 1ff8 <MAX_CHILD+0x8>
    1b72:	00000817          	auipc	a6,0x0
    1b76:	48e83803          	ld	a6,1166(a6) # 2000 <MAX_CHILD+0x10>
...
char *stpncpy(char *restrict d, const char *s, size_t n)
{
    ...
    1d50:	2ac8b883          	ld	a7,684(a7) # 1ff8 <MAX_CHILD+0x8>
    1d54:	00000817          	auipc	a6,0x0
    1d58:	2ac83803          	ld	a6,684(a6) # 2000 <MAX_CHILD+0x10>
    1d5c:	431d                	li	t1,7
